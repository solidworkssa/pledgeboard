# 14-pledgeboard - Base Native Architecture
...
Community pledge tracker

## Overview

Pledgeboard provides a decentralized solution for public commitment tracking and verification on both Base (EVM) and Stacks blockchains.
